...
@torch.no_grad()
def run(poseweights="yolov7-w6-pose.pt",source="./input/pushups1.mp4",device='cpu',curltracker=False,drawskeleton=False):
    path = source
    ...
    if ext in ["mp4","webm","avi"] or ext not in ["mp4","webm","avi"] and ext.isnumeric():
        ...
        cap = cv2.VideoCapture("./input/pushups1.mp4")  
        webcam = False
            ...
            if ret: 
                ...
                if curltracker:
                    ...
                    for idx in range(output.shape[0]):
                        ...
                        #PercentageR = np.interp(angleR, (start_angle_R, end_angle_R), (100, 0))
                        Percentage = np.interp(angleL, (start_angle_L, end_angle_L), (0, 100))
