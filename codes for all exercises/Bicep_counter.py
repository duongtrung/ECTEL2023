            ...
            if ret: 
                ...
                if curltracker:
                    ...
                    for idx in range(output.shape[0]):
                        ...
                        Percentage = np.interp(angleR,(10, 150),(100, 0))
                        
                        bar = np.interp(angleR,(30, 150),(int(fh)-100, 200))
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, help='video/0 for webcam') ce
    parser.add_argument('--device', type=str, default='cpu', help='cpu/0,1,2,3(gpu)')   
    parser.add_argument('--curltracker', type=bool, default='True', help='set as true to check count bicep curls')   
    parser.add_argument('--drawskeleton', type=bool, default='False', help='set as True to draw skeleton')   
